...
public abstract class AbstractApplicationContext extends DefaultResourceReader implements ConfigurableApplicationContext {
    ...
    public void refresh() throws BeansException {
        ...
        // 3. 在 Bean 实例化之前，执行 执行 BeanFactoryPostProcessor (Invoke factory processors registered as beans in the context.)
        invokeBeanFactoryPostProcessors(beanFactory);
        // 4. BeanPostProcessor 需要提前于其它 Bean 对象实例化之前执行注册操作
